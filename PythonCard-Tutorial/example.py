...
class MyBackground(model.Background):
    ...
    def on_doHelpAbout_command(self, event):
        ...
        result = dialog.alertDialog(self, 'This has been modified', 'Hello')

    #The login button
    def on_cmdLogin_mouseClick(self, event):
        result = dialog.alertDialog(self, self.components.txtIdent.text,
        'Session Login')
        
    #The reset button
    def on_cmdReset_mouseClick(self, event):
        self.components.txtIdent.text = ""
        self.components.txtAuthKey.text = ""        
